...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-[#0F4C81] text-white shadow-sm hover:bg-[#0F4C81]/90 hover:shadow-md",
        destructive:
          "bg-red-500 text-white shadow-sm hover:bg-red-500/90",
        outline:
          "border border-[#0F4C81]/20 bg-white text-[#0F4C81] shadow-sm hover:bg-[#0F4C81]/5 hover:border-[#0F4C81]/40",
        secondary:
          "bg-[#10B981] text-white shadow-sm hover:bg-[#10B981]/90 hover:shadow-md",
        ghost:
