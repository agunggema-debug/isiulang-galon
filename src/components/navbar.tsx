...
import { Menu, X, Droplets, Flame, User } from "lucide-react";
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-2 md:hidden">
              ...
              <button
                ...
                className="p-2 text-gray-600 hover:text-[#0F4C81] transition-colors"
            ...
            <div className="md:hidden border-t border-gray-100 py-4 space-y-3">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block px-3 py-2 text-sm font-medium text-gray-600 hover:text-[#0F4C81] hover:bg-gray-50 rounded-lg transition-colors duration-200"
